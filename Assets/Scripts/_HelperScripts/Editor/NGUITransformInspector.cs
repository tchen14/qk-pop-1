...
public class NGUITransformInspector : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.BeginHorizontal();
		{
			...
			{
				RegisterUndo("Reset Position", serializedObject.targetObjects);
		...
		EditorGUILayout.BeginHorizontal();
		{
			...
			{
				RegisterUndo("Reset Rotation", serializedObject.targetObjects);
		...
		EditorGUILayout.BeginHorizontal();
		{
			...
			{
				RegisterUndo("Reset Scale", serializedObject.targetObjects);
		...
		{
			RegisterUndo("Transform Change", serializedObject.targetObjects);
