	...
	public class Debug {
		...
		void OnEnable() {
			...
			if (logStrings.Count == 0) {
				string text = System.IO.File.ReadAllText(Application.dataPath + StringManager.DEBUGKEYS);
...
#endif
		public static void DrawLine (Vector3 start, Vector3 end, Color color = default(Color),
		                             float duration = 0.0f, bool depthTest = true) {
			Debug.DrawLine(start, end, color, duration, depthTest);
		}
		public static void DrawRay (Vector3 start, Vector3 end, Color color = default(Color),
		                            float duration = 0.0f, bool depthTest = true) {
