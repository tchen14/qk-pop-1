...
public abstract class Camera_2 : MonoBehaviour
{
	...
	public float mouseWheelSensitivity = 5f;   			// Mouse Wheel Sensetivity
	...
	[HideInInspector]
	public Vector3 desiredPosition = Vector3.zero;		// Stores desired camera position during calculation
