...
public static class PopEventCore {
    ...
    public static string[] executeTypes = { "Choose An Action", "Execute Function", "Debug Message", "Activate Next Event", "Activate Another Event", "Deactivate Another Event", "Create Prefab", "Create Text Box", "Destroy Text Box" };
}